  ...
  const handleGPTSearchClick = async () => {
    try {
      const gptQuery =
        ...
        ' Only give me names of 5 movies, comma separated like the example result given ahead: Example Result: Rebel Moon: Part One - A Child of Fire, Wonka, Leave the World Behind, The Iron Claw , Maestro'
      ...
      console.error(
        'Error occurred while fetching data from OpenAI:',
        error.message
      )
    ...
    <div className="pt-[39%] md:pt-[10%] flex justify-center">
      ...
      >
        ...
        <button
          ...
          className="py-2 px-3 md:px-4 col-span-12 lg:col-span-3 bg-red-700 text-white rounded-lg mt-2 lg:mt-0"
        >
          {lang[langKey]?.search}
        </button>
      </form>
